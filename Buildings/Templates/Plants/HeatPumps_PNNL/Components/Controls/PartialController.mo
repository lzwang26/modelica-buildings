  ...
  */
  ...
  Buildings.Templates.Plants.HeatPumps.Interfaces.Bus bus
    ...
    annotation (Placement(transformation(extent={{-20,-20},{20,20}},rotation=90,
      origin={-260,0}),
      iconTransformation(extent={{-20,-20},{20,20}},rotation=90,origin={-100,64})));
  ...
  Buildings.Templates.ZoneEquipment.Interfaces.Bus busEquZon[nEquZon]
    ...
    annotation (Placement(transformation(extent={{-20,-20},{20,20}},rotation=-90,
      origin={260,-140}),
      iconTransformation(extent={{-20,-20},{20,20}},rotation=-90,origin={100,-60})));
  Buildings.Templates.Components.Interfaces.Bus bus_HeaPum annotation (
      Placement(transformation(extent={{-184,-392},{-144,-352}}),
        iconTransformation(
        extent={{-20,-20},{20,20}},
        rotation=90,
        origin={-102,-60})));
  Buildings.Templates.Components.Interfaces.Bus bus_CooPum annotation (
      Placement(transformation(extent={{50,-378},{90,-338}}),
        iconTransformation(
        extent={{-20,-20},{20,20}},
        rotation=90,
        origin={-100,2})));
