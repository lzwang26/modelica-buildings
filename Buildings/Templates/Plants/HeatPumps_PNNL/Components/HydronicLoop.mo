...
model HydronicLoop
  ...
  Modelica.Blocks.Sources.Constant const5(k=1)
    annotation (Placement(transformation(extent={{194,118},{214,138}})));
  ...
  Modelica.Blocks.Sources.Constant const7(k=0)
    annotation (Placement(transformation(extent={{-288,108},{-268,128}})));
  ...
  Modelica.Blocks.Sources.Constant const9(k=0)
    annotation (Placement(transformation(extent={{-332,-18},{-312,2}})));
  ...
  Modelica.Blocks.Sources.Constant const11(k=0)
    annotation (Placement(transformation(extent={{316,52},{336,72}})));
  Modelica.Blocks.Sources.Constant const13(k=0)
    annotation (Placement(transformation(extent={{236,52},{256,72}})));
...
equation
  ...
  connect(res2.port_a, jun5.port_2) annotation (Line(points={{2,20},{2,-60},{44,
          -60}},                 color={0,127,255}));
  ...
  connect(const5.y, val.y) annotation (Line(points={{215,128},{215,104},{216,
          104},{216,80},{152,80}}, color={0,0,127}));
  connect(const6.y, val3.y) annotation (Line(points={{-67,128},{-58,128},{-58,
          80},{-98,80}}, color={0,0,127}));
  connect(const7.y, val7.y) annotation (Line(points={{-267,118},{-258,118},{
          -258,0},{-248,0}}, color={0,0,127}));
  connect(const7.y, val5.y) annotation (Line(points={{-267,118},{-226,118},{
          -226,4},{-186,4}}, color={0,0,127}));
  connect(const8.y, mov2.dp_in) annotation (Line(points={{-87,-8},{-78,-8},{-78,
          28},{-70,28}}, color={0,0,127}));
  connect(const9.y, mov4.dp_in) annotation (Line(points={{-311,-8},{-302,-8},{
          -302,28},{-300,28}}, color={0,0,127}));
  connect(const10.y, val2.y) annotation (Line(points={{97,-44},{82,-44},{82,-16},
          {66,-16}}, color={0,0,127}));
  connect(const11.y, mov3.dp_in) annotation (Line(points={{337,62},{344,62},{
          344,32},{350,32}}, color={0,0,127}));
  connect(const13.y, val9.y) annotation (Line(points={{257,62},{257,47},{276,47},
          {276,32}}, color={0,0,127}));
  connect(const14.y, val8.y) annotation (Line(points={{87,184},{87,153},{110,
          153},{110,122}}, color={0,0,127}));
