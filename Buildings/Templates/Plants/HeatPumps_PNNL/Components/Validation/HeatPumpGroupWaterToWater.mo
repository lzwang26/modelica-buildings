...
model HeatPumpGroupWaterToWater
  ...
  parameter Buildings.Templates.Plants.HeatPumps.Components.Data.Controller datCtlPlaAw(
    cfg(
      have_chiWat=true,
      typPumHeaWatPri=Buildings.Templates.Plants.HeatPumps.Types.PumpsPrimary.Variable,
  ...
  Buildings.Templates.Plants.HeatPumps.Components.Data.Controller ctlPlaAwNrv(
    final cfg=datCtlPlaAwNrv.cfg,
    final dat=datCtlPlaAwNrv)
    "Plant controller"
    annotation (Placement(transformation(extent={{-20,130},{-40,150}})));
  Buildings.Templates.Plants.HeatPumps.Components.HeatPumpGroups.AirToWater hpAwNrv(
  ...
  Buildings.Templates.Plants.HeatPumps.Components.HeatPumpGroups.AirToWater hpAw(
    redeclare final package MediumHeaWat=Medium,
    nHp=3,
    is_rev=true,
    final dat=datHpAw,
  ...
  Buildings.Templates.Plants.HeatPumps.Components.Controls.OpenLoop ctlPlaAw(
