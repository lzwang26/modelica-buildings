within Buildings.Templates.Plants.HeatPumps_PNNL.Components.Interfaces;
model PartialHeatPumpGroup_WW
  ...
  */
  ...
  Modelica.Fluid.Interfaces.FluidPorts_b ports_bChiWat[nHp](
    ...
    "CHW supply" annotation (Placement(transformation(
        extent={{-10,-40},{10,40}},
        rotation=90,
