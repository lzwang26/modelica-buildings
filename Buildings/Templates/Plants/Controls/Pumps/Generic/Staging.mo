...
block Staging
  ...
  Buildings.Controls.OBC.CDL.Interfaces.BooleanInput u1ValInlIso[nEqu] if
       is_pri and is_hdr and have_valInlIso
    "Equipment inlet isolation valve command"
    annotation (Placement(transformation(extent={{-200,-60},{-160,-20}}),
      iconTransformation(extent={{-140,40},{-100,80}})));
  Buildings.Controls.OBC.CDL.Interfaces.BooleanInput u1Equ[nEqu] if
       not is_hdr and is_pri
    "Equipment enable signal"
    annotation (Placement(transformation(extent={{-200,-140},{-160,-100}}),
      iconTransformation(extent={{-140,60},{-100,100}})));
  Buildings.Controls.OBC.CDL.Interfaces.BooleanInput u1Equ_actual[nEqu] if
       not is_hdr and is_pri
    "Equipment status"
    annotation (Placement(transformation(extent={{-200,-160},{-160,-120}}),
      iconTransformation(extent={{-140,-40},{-100,0}})));
  Buildings.Controls.OBC.CDL.Interfaces.BooleanInput u1ValOutIso[nEqu] if
       is_pri and is_hdr and have_valOutIso
