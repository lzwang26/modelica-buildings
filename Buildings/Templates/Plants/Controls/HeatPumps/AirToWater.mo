...
block AirToWater
  ...
  final parameter Boolean have_pumSecCtlDp=have_pumHeaWatSec or have_pumChiWatSec
    ...
    annotation (Evaluate=true,
    Dialog(group="Plant configuration"));
  // RFE(AntoineGautier): Add option for sidestream HRC.
  ...
  Buildings.Controls.OBC.CDL.Interfaces.IntegerInput nReqPlaHeaWat
    "Number of HW plant requests" annotation (Placement(transformation(extent={
            {-300,320},{-260,360}}), iconTransformation(extent={{-240,80},{-200,
            120}})));
  ...
  Buildings.Controls.OBC.CDL.Interfaces.RealOutput TSupSet[nHp](
    final unit="K",
    final quantity="ThermodynamicTemperature",
    displayUnit="degC") if have_chiWat "Active HP supply temperature setpoint"
...
equation
  ...
  connect(resChiWat.dpSet, dpChiWatRemSet)
    annotation (Line(points={{112,-14},{234,-14},{234,-80},{280,-80}},color={0,0,127}));
  ...
  connect(resHeaWat.TSupSet, chaStaHea.TSupSet)
    annotation (Line(points={{112,234},{116,234},{116,220},{-52,220},{-52,316},
          {-42,316}},
      color={0,0,127}));
  ...
  connect(ctlPumHeaWatSec.y, yPumHeaWatSec)
    annotation (Line(points={{161.8,20},{238,20},{238,0},{280,0}},color={0,0,127}));
  connect(ctlPumChiWatSec.y, yPumChiWatSec)
    annotation (Line(points={{211.8,0},{236,0},{236,-20},{280,-20}},color={0,0,127}));
  ...
  connect(resChiWat.TSupSet, TChiWatSupSet.u) annotation (Line(points={{112,-26},
          {114,-26},{114,-140},{198,-140}}, color={0,0,127}));
  connect(resHeaWat.TSupSet, THeaWatSupSet.u) annotation (Line(points={{112,234},
          {116,234},{116,-100},{198,-100}}, color={0,0,127}));
