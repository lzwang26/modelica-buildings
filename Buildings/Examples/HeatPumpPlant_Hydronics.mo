...
model HeatPumpPlant_Hydronics
  ...
  parameter Modelica.Units.SI.Pressure p_priEnergyFlow_nominal_junctions[3] = {1, 2, 3}
  ...
  Fluid.FixedResistances.PressureDrop
    ...
    m_flow_nominal=m_priEnergyFlow_nominal,
    dp_nominal=p_priEnergyFlow_nominal)
    annotation (Placement(transformation(extent={{206,32},{226,52}})));
...
equation
  ...
  connect(jun6.port_2, res4.port_a) annotation (Line(points={{190,40},{198,40},
          {198,42},{206,42}}, color={0,127,255}));
  connect(res4.port_b, jun12.port_1) annotation (Line(points={{226,42},{234,42},
          {234,40},{240,40}}, color={0,127,255}));
