...
model Mode_2A
  ...
  Modelica.Blocks.Sources.Constant const4(k=1)
    annotation (Placement(transformation(extent={{-310,-2},{-290,18}})));
...
equation
  ...
  connect(jun10.port_2, jun8.port_2)
    annotation (Line(points={{-188,40},{-122,40}}, color={0,127,255}));
  connect(jun11.port_1, jun9.port_2)
    annotation (Line(points={{-188,-40},{-170,-40}}, color={0,127,255}));
  connect(val5.port_a, jun10.port_3)
    annotation (Line(points={{-198,14},{-198,30}}, color={0,127,255}));
  connect(val5.port_b, jun11.port_3)
    annotation (Line(points={{-198,-6},{-198,-30}},
                                                  color={0,127,255}));
  ...
  connect(jun14.port_1, jun11.port_2)
    annotation (Line(points={{-250,-40},{-208,-40}}, color={0,127,255}));
  ...
  connect(bou2.ports[1], mov4.port_b)
    annotation (Line(points={{-330,42},{-320,42},{-320,40},{-310,40}},
                                                   color={0,127,255}));
  connect(gai.u, val2.y_actual) annotation (Line(points={{198,-90},{68,-90},{68,
          -1},{61,-1}},  color={0,0,127}));
  ...
  connect(addPar.y, val6.y) annotation (Line(points={{262,-90},{340,-90},{340,0},
          {322,0}}, color={0,0,127}));
  connect(val.y_actual, val1.y) annotation (Line(points={{147,75},{147,56},{110,
          56},{110,76},{92,76}},color={0,0,127}));
  ...
  connect(const4.y, mov4.dp_in)
    annotation (Line(points={{-289,8},{-300,8},{-300,28}}, color={0,0,127}));
  ...
  connect(mov1.port_b, jun5.port_1)
    annotation (Line(points={{136,-40},{64,-40}}, color={0,127,255}));
  ...
  connect(jun16.port_2, jun17.port_2)
    annotation (Line(points={{64,40},{70,40}}, color={0,127,255}));
  connect(jun17.port_1, jun4.port_2)
    annotation (Line(points={{90,40},{130,40}}, color={0,127,255}));
  connect(jun17.port_3, val1.port_b)
    annotation (Line(points={{80,50},{80,66}}, color={0,127,255}));
  ...
  connect(jun14.port_2, res6.port_a) annotation (Line(points={{-270,-40},{-328,
          -40},{-328,-16}}, color={0,127,255}));
  connect(res6.port_b, bou2.ports[2]) annotation (Line(points={{-328,4},{-328,
          22},{-328,38},{-330,38}}, color={0,127,255}));
