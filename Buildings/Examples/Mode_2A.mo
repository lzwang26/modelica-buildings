...
model Mode_2A
  ...
  extends Buildings.Examples.HeatPumpPlant_baseclass(const4(k=0));
...
equation
  ...
  connect(const.y, val7.y) annotation (Line(points={{-197,80},{-180,80},{-180,
          22},{-240,22},{-240,0},{-248,0}}, color={0,0,127}));
  connect(const7.y, val.y) annotation (Line(points={{171,150},{180,150},{180,80},
