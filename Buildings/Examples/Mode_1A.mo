...
model Mode_1A
  ...
  Modelica.Blocks.Sources.Constant const11(k=1)
    annotation (Placement(transformation(extent={{-266,-90},{-246,-70}})));
...
equation
  ...
  connect(const10.y, val2.y) annotation (Line(points={{61,-90},{80,-90},{80,-16},
          {66,-16}},  color={0,0,127}));

  connect(const11.y, val7.y) annotation (Line(points={{-245,-80},{-228,-80},{
          -228,0},{-248,0}}, color={0,0,127}));
  connect(const7.y, mov1.y)
    annotation (Line(points={{141,-10},{146,-10},{146,-48}}, color={0,0,127}));
  connect(const13.y, val.y) annotation (Line(points={{171,150},{180,150},{180,80},
