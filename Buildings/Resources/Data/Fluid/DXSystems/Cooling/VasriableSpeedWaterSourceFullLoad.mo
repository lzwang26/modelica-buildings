within ;
model VasriableSpeedWaterSourceFullLoad
 ...
 Modelica.Blocks.Sources.TimeTable speRat(table=[0,0; 3600,0; 3600,0; 7200,0;
  ...
  Modelica.Blocks.Sources.RealExpression XEvaInMod(y=datRea.y[9]/(1 + datRea.y[9]))
    "Modified XEvaIn"
  ...
  Buildings.Fluid.Sensors.TemperatureTwoPort TConOut(m_flow_nominal=0.38, redeclare
      package Medium =
               MediumWater) "Outlet temperature at the condenser"
  ...
  Modelica.Blocks.Sources.CombiTimeTable datRea(
    final fileName=ModelicaServices.ExternalReferences.loadResource("modelica://Buildings/Resources/Data/Fluid/DXSystems/Cooling/ZoneVSWSHP_wDOAS_FullLoad.dat"),
...
equation
  ...
  connect(datRea.y[8], TEvaIn_K.Celsius) annotation (Line(points={{-121,66},{-114,
          66},{-114,68},{-112,68},{-112,-10.4},{-102,-10.4}}, color={0,0,127}));
  connect(datRea.y[13], TCIn_K.Celsius) annotation (Line(points={{-121,66},{132,
          66},{132,-30},{128,-30},{128,-30.4},{122,-30.4}}, color={0,0,127}));
  connect(datRea.y[22], varSpeDX.speRat) annotation (Line(points={{-121,66},{
          -66,66},{-66,18},{-11.2,18}}, color={0,0,127}));
  connect(datRea.y[7], souAir.m_flow_in) annotation (Line(points={{-121,66},{
...
end VasriableSpeedWaterSourceFullLoad;
